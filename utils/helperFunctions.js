...
import { onAuthStateChanged, signInWithPopup, getAdditionalUserInfo } from "firebase/auth";
            ...
            if (currentUser) {
              ...
              if (Globals.profileImageUrl) {
                const storageRef = firebase
                  .storage()
                  .ref(Globals.profileImageUrl);
                storageRef.delete().catch((error) => {
                  console.error(
                    "Error deleting user image from Firebase Storage:",
                    error
                  );
                });
              }
